...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=cfg.class_num, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None, norm_layer=None , learn_method=cfg.learn_method):
...
def resnet18(num_classes=cfg.class_num,learn_method=cfg.learn_method):
    ...
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], num_classes, learn_method=learn_method)
